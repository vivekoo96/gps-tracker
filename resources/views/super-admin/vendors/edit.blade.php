                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            <div>
                                ...
                                <div class="flex items-center space-x-3">
                                    <input type="color" name="primary_color" id="primary_color" value="{{ old('primary_color', $vendor->primary_color ?? '#051643') }}" class="h-10 w-20 rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-900 shadow-sm focus:ring-indigo-500 focus:border-indigo-500 cursor-pointer">
                                    <input type="text" id="color_hex" value="{{ old('primary_color', $vendor->primary_color ?? '#051643') }}" class="block w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-900 dark:text-gray-200 shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm uppercase" maxlength="7">
                                </div>
