                    ...
                    <form method="POST" action="{{ route('admin.routes.store') }}">
                        ...
                        <div class="grid grid-cols-1 gap-6">
                            ...
                            <div>
                                ...
                                <textarea name="description" id="description" rows="3" class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-200 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"></textarea>
                            </div>

                            <div>
                                <label for="stops" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Route Stops (JSON Format)</label>
                                <textarea name="stops" id="stops" rows="5" placeholder='[{"lat": 17.385, "lng": 78.486}, {"lat": 17.400, "lng": 78.500}]' class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-200 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm font-mono"></textarea>
